...
for the training.
"""
function set_reward!(env::RLEnv{DefaultReward}, model::CPModel, symbol::Union{Nothing, Symbol})
    nothing
end
...
"""
function set_final_reward!(env::RLEnv{DefaultReward}, model::CPModel, symbol::Union{Nothing, Symbol})
