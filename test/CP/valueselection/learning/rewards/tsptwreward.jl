...
lh = SeaPearl.SimpleLearnedHeuristic{SeaPearl.TsptwStateRepresentation{SeaPearl.TsptwFeaturization, SeaPearl.TsptwTrajectoryState}, SeaPearl.TsptwReward, SeaPearl.FixedOutput}(agent)
